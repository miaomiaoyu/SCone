function [data,time,meta] = Import_Axo_New_Folder(filename, foldername)
%==============================================================================
% IMPORTAXO   
...
for iFn = 1:length(fn)
	...
	save(fullfile(pn,foldername,fstem),'time','data','meta');
	fprintf(1,' successfully imported ');
end
