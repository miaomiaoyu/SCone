function stimRGB=LMS2RGB_Vpixx(stimLMS,fundamentals,resampledSpectra)
...
if nargin < 3 || isempty (resampledSpectra)
    ...
    load('/Users/miaomiaoyu/Google Drive/matlab_toolboxes/viewpixx_calibration/Viewpixx_Processed_cal_data_7_8_2017_1.mat')
end
